...
var HomePage = /** @class */ (function () {
    function HomePage(router, modalController, user) {
        this.router = router;
    ...
    HomePage.prototype.power = function (e) {
        this.status = !this.status;
        var value = this.status ? '1' : '0';
        // this.formData.append('flag', value); 
        console.log(value);
        this.user.power(value).subscribe(function (res) { console.log(res); });
    };
